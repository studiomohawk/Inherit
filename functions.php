...
'name' => 'Footer',
'before_widget' => '<div class="grid_4 widget %2$s">',
'after_widget' => '</div>',
'before_title' => '<h4>',
'after_title' => '</h4>',
));
...
register_sidebar(array(
'name' => 'inspiration',
'before_widget' => '<div class="inspiration grid_12 widget %2$s">',
'after_widget' => '</div>',
'before_title' => '<h4>',
'after_title' => '</h4>',
));
...
register_sidebar(array(
'name' => 'underArticle',
'before_widget' => '<div class="underArticle widget %2$s">',
'after_widget' => '</div>',
'before_title' => '<h4>',
'after_title' => '</h4>',
));
?>
<?php
function sm_prevnext() {
	if(get_previous_post()):
		previous_post_link('%link', '&laquo; <span>Previous</span>');
	else:
	...
	<?php if(get_next_post()):
		next_post_link('%link', '<span>Next</span> &raquo;');
	else:
